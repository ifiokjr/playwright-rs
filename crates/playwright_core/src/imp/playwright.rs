...
use crate::api::browser::ContextBuilder;
use crate::api::browser_type::PersistentContextLauncher;
...
use crate::protocol::generated::playwright as protocol;
...
impl Playwright {
  ...
  pub(crate) fn selectors(&self) -> Weak<Selectors> {
