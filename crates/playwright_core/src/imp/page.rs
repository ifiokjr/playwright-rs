...
use crate::imp::core::*;
use crate::imp::download::Download;
use crate::imp::element_handle::may_save;
use crate::imp::file_hooser::FileChooser;
...
macro_rules! navigation {
  ($f:ident, $m:literal) => {
    pub(crate) async fn $f(&self, args: ReloadArgs) -> Result<Option<Weak<Response>>, Arc<Error>> {
...
impl Page {
  ...
  fn on_download(&self, ctx: &Context, params: Map<String, Value>) -> Result<(), Error> {
    ...
    // TODO: set_is_remote
    // artifactObject._isRemote = !!this._browserContext._browser &&
    // this._browserContext._browser._isRemote;
