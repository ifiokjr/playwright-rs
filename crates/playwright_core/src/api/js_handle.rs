...
use crate::imp::core::*;
use crate::imp::js_handle::JsHandle as Impl;
use crate::imp::prelude::*;

/// JsHandle represents an in-page JavaScript object. JsHandles can be created
/// with the [`method: Page.evaluateHandle`] method.
///
/// ```js
...
impl JsHandle {
  ...
  /// The method returns a map with **own property names** as keys and JsHandle
